...
{ // make the stackTop points to the next element to be added in the stack.
...
#define READ_CONSTANT_LONG() ((Value)vm.chunk->constants.values[(uint32_t)READ_BYTE() | ((uint32_t)READ_BYTE() << 8) | ((uint32_t)READ_BYTE() << 16)])
#define BINARY_OP(op)                                                                                                                                                                                  \
    do                                                                                                                                                                                                 \
    {                                                                                                                                                                                                  \
        Value b = pop();                                                                                                                                                                               \
